...
Route::post('/item/updatePriceCount/{id}', [PostController::class, 'updatePriceCount'])->name('update-price');
...
Route::get('/test', [HomeController::class, 'testIndex'])->name('test-env');
